...
then
    rm ${CONDOR_DIR_INPUT}/MyToolAnalysis_EventBuilding/${TOOLCHAIN_FILE}/my_files.txt
    echo $FILENAME > ${CONDOR_DIR_INPUT}/MyToolAnalysis_EventBuilding/${TOOLCHAIN_FILE}/my_files.txt
fi
...
# setup software
export TOOLANALYSIS_PATH=${CONDOR_DIR_INPUT}/MyToolAnalysis_EventBuilding
...
${TOOLANALYSIS_PATH}/Analyse $TOOLCHAIN_FILE/ToolChainConfig > decoding_${FILENAME}.log
#exit
