...
SOURCEFILEZIP=dsnb_Madau2014_T5MeV_SK.tar.gz
...
OUTDIR=/pnfs/annie/persistent/users/mnieslon/wcsim/output/tankonly/wcsim_dsnb_Madau2014_T5MeV_SK_2020-09-23
...
source WCSim_SK/envHadronic.sh

#copy the histogram input files
cd build
ifdh cp -D ../WCSim_SK/DSNB_antinu_prob_cumulative_Madau2014_T5MeV.txt .
cd ..
