...
#		echo "WBRATIO: ${wbratio}"
		jobsub_submit -N 1000 --memory=2048MB --expected-lifetime=long --resource-provides=usage_model=DEDICATED,OPPORTUNIST -G annie file:///annie/app/users/mnieslon/send_grid/grid_beamlike_electron.sh ${ratio} ${wbratio}
#	done < $WBRATIOLIST
#done < $RATIOLIST
