...
#		echo "WBRATIO: ${wbratio}"
		jobsub_submit -N 400 --memory=2048MB --expected-lifetime=long --resource-provides=usage_model=DEDICATED,OPPORTUNIST -G annie file:///annie/app/users/mnieslon/send_grid/grid_beamlike_muon.sh ${ratio} ${wbratio}
#	done < $WBRATIOLIST
#done < $RATIOLIST
