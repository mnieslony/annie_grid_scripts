...
SOURCEFILEZIP=dsnb_Madau2014_T5MeV_new.tar.gz
...
OUTDIR=/pnfs/annie/persistent/users/mnieslon/wcsim/output/tankonly/wcsim_dsnb_Madau2014_T5MeV_2020-05-02
...
OUTFILE=wcsim_0.${THECOUNTER}.root
#OUTFILE=wcsim_0.${PROCESSNUM}.root
OUTLOG=wcsim_0_${THECOUNTER}.log
...
cd build
ifdh cp -D ../WCSim/DSNB_antinu_prob_cumulative.txt .
ifdh cp -D ../WCSim/histogram_beamlike_e.dat .
ifdh cp -D ../WCSim/histogram_beamlike_mu.dat .
ifdh cp -D ../WCSim/DSNB_antinu_prob_cumulative_Madau2014_T5MeV.txt .
cd ..
